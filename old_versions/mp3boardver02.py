...
class AudioButtonApp:
    def __init__(self, root):
        ...
        # Agregar botones para guardar/cargar configuración
    ...
    def handle_button_press(self, row, col):
        ...
        if button_key in self.button_audio_map:
            ...
            # Preguntar si desea asignar un archivo o cambiar el nombre del botón
            choice = messagebox.askyesno("Asignar archivo", "¿Desea asignar un archivo al botón?")
            if choice:
